...
#+begin_src emacs-lisp
  ...
  (require 'color)
  (let ((whitespace-color (color-darken-name theme-darkest-text-color 10)))
    (custom-set-faces
     `(whitespace-newline                ((t (:foreground ,whitespace-color))))
     `(whitespace-missing-newline-at-eof ((t (:foreground ,whitespace-color))))
     `(whitespace-space                  ((t (:foreground ,whitespace-color))))
     `(whitespace-space-after-tab        ((t (:foreground ,whitespace-color))))
     `(whitespace-space-before-tab       ((t (:foreground ,whitespace-color))))
     `(whitespace-tab                    ((t (:foreground ,whitespace-color))))
     `(whitespace-trailing               ((t (:foreground ,whitespace-color))))))
#+end_src
